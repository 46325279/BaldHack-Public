package club.baldhack.gui.rgui.render.util;

import java.util.HashMap;
import java.util.Map;

import static club.baldhack.gui.rgui.render.util.ShaderHelper.createProgram;
import static club.baldhack.gui.rgui.render.util.ShaderHelper.loadShader;
