package club.baldhack.command;

import club.baldhack.command.commands.BindCommand;
import club.baldhack.BaldHack;
import club.baldhack.util.ClassFinder;
...
public class CommandManager {
	...
	public CommandManager() {
		...
		BaldHack.log.info("Commands initialised");
	}
