package club.baldhack.module;

import club.baldhack.module.modules.movement.Sprint;
...
public class Module {
    ...
    public void enable() {
        ...
        onEnable();
        if (!alwaysListening)
            BaldHack.EVENT_BUS.subscribe(this);
    }
    ...
    public void disable() {
        ...
        onDisable();
        if (!alwaysListening)
            BaldHack.EVENT_BUS.unsubscribe(this);
    }
    ...
    protected final void setAlwaysListening(boolean alwaysListening) {
        ...
        if (alwaysListening) BaldHack.EVENT_BUS.subscribe(this);
        if (!alwaysListening && isDisabled()) BaldHack.EVENT_BUS.unsubscribe(this);
    }
